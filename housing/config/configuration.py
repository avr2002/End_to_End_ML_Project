...
class Configuration:
    ...
    def get_data_ingestion_config(self) -> DataIngestionConfig:
        try:
            # print(self.training_pipeline_config[0].artifact_dir)
            # artifact_dir = self.training_pipeline_config.artifact_dir  -> Not Working as self.training_pipeline_config gives back a tuple
            artifact_dir = self.training_pipeline_config[0].artifact_dir
            ...
            tgz_download_dir = os.path.join(data_ingestion_artifact_dir,
                                            data_ingestion_info[DATA_INGESTION_TGZ_DATA_DIR_KEY])
    ...
    def get_model_trainer_config(self) -> ModelTrainerConfig:
        try:
            ...
            trained_model_file_path = os.path.join(model_trainer_artifact_dir,
                                                   model_trainer_config_info[MODEL_TRAINER_TRAINED_MODEL_DIR_NAME_KEY],
    ...
    def get_model_evaluation_config(self) -> ModelEvaluationConfig:
        try:
            ...
            model_evaluation_config_info = self.config_info[MODEL_EVALUATION_CONIG_KEY]
    ...
    def get_model_pusher_config(self) -> ModelPusherConfig:
        try:
            ...
            model_pusher_artifact_dir = os.path.join(artifact_dir,
                                                    MODEL_PUSHER_ARTIFACT_DIR_NAME,
                                                    self.time_stamp)

            model_pusher_config_info = self.config_info[MODEL_PUSHER_CONFIG_KEY]

            export_dir_path = os.path.join(model_pusher_artifact_dir,
                                           model_pusher_config_info[MODEL_PUSHER_MODEL_EXPORT_DIR_NAME_KEY])
